...
(custom-set-variables
 ...
 '(after-save-hook
   '(rmail-after-save-hook doom-modeline-update-vcs-text doom-modeline-update-vcs-icon doom-modeline-update-buffer-file-name org-roam-db-build-cache))
 ...
 '(org-todo-keywords
   '((sequence "TODO" "DOING" "BLOCKED" "REVIEW" "|" "DONE" "ARCHIVED")
     (sequence "WANTTO" "SPEC" "FINDOUT" "DECIDE" "HOTOWTO" "TRY" "FAILED" "GOTO" "DO")
